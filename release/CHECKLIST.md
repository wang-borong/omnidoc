...
2. Run:
   ...
   OMNIDOC_RELEASE_TAG=v1.0.0 scripts/package-release.sh /tmp/omnidoc-libs-release
   scripts/smoke-test.sh
   ```

3. Commit, create and push the signed `v1.0.0` tag.
...
curl --fail --location --head \
  https://github.com/wang-borong/omnidoc-libs/releases/download/v1.0.0/omnidoc-libs-v1.0.0.tar.gz
curl --fail --location --head \
  https://github.com/wang-borong/omnidoc-libs/releases/download/v1.0.0/omnidoc-libs-v1.0.0.tar.gz.sha256
...
2. Commit, create and push the signed `v1.3.0` tag.
