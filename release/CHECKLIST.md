...
2. Run:
   ...
   OMNIDOC_RELEASE_TAG=v1.1.1 scripts/package-release.sh /tmp/omnidoc-libs-release
   scripts/smoke-test.sh
   ```

3. Commit, create and push the `v1.1.1` tag.
...
curl --fail --location --head \
  https://github.com/wang-borong/omnidoc-libs/releases/download/v1.1.1/omnidoc-libs-v1.1.1.tar.gz
curl --fail --location --head \
  https://github.com/wang-borong/omnidoc-libs/releases/download/v1.1.1/omnidoc-libs-v1.1.1.tar.gz.sha256
